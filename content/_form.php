                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">Form</h4>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h4 class="header-title">Isi Form Berikut</h4>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="" placeholder="Fill the name" id="example-text-input">
                                                </div>
                                            </div>

                                                <div class="form-group row">
                                                <label class="col-md-2 col-form-label">Ocupation</label>
                                                <div class="col-md-10">
                                                    <select class="custom-select">
                                                        ...
                                                        <option value="Luxury Goods Supplier and Distributor">Luxury Goods Supplier and Distributor</option>
                                                        <option value="Wheat Farmer">Wheat Farmer</option>
                                                        ...
                                                        <option value="Fruit Farmer">Fruit Farmer</option>
                                                        <option value="Electronics Seller">Electronics Seller</option>
                                             ...
                                             <div class="form-group row">
                                                <label for="example-text-input" class="col-md-2 col-form-label">Sallary</label>
                                                <div class="col-md-10">
                                                    <input class="form-control" type="text" value="" placeholder="Sallary will generate automaticalyy" id="example-text-input">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <h3><span class="badge badge-soft-primary">Rp 60.000.000</span></h3>
                                                </div>
                                            </div>
