                    ...
                    <div class="page-title-box">
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <h4 class="page-title mb-1">Case 1</h4>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                               <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h1 class="header-title">Studi Kasus 1</h1>
                                            <p class="card-title-desc"></p>
                                            <h3 class="mb-0">
                                            Last year until now, population has declined, due to a falling <a data-toggle="modal" data-target=".bs-example-modal-center" href="#">birth rate</a>, and a high proportion of its population is now aged over 64. The government has used tax revenue to give cash <a data-toggle="modal" data-target=".incentives" href="#">incentives</a> to couples to have more children. However, many parents have chosen to have fewer children and spend more on each child to ensure they get a good education. The country now has fewer but larger schools.
                                            </h3>
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title mt-0">Birth Rate</h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <p>Birth rate = the number of births that happen during a period of time in a particular place</p>
                                                                        </div>
                                                                    </div><!-- /.modal-content -->
                                                                </div><!-- /.modal-dialog -->
                                                            </div><!-- /.modal -->
                                            ...
                                            <div class="modal fade incentives" tabindex="-1" role="dialog" aria-labelledby="incentives" aria-hidden="true">
                                                                <div class="modal-dialog modal-dialog-centered">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title mt-0">Incentives</h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            <p> Incentives = something that encourages a person to do something</p>
                                                                        </div>
                                                                    </div><!-- /.modal-content -->
                                                                </div><!-- /.modal-dialog -->
                                                            </div><!-- /.modal -->
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <p class="card-title-desc">Sign The component value</p>

                                             <h3>Saldo : <span class="badge badge-soft-primary">Rp 60.000.000</span></h3>
